...
if (!isset($_SESSION['unique_id'])) {
    ...
    $UserFullName = $arrUserID['fullName'];
}
...
<!-- Preloader -->
<!-- <div class="preloader">
    <img src="assets/images/Flippingbook Page.gif" alt="">
</div> -->
...
<body>
    ...
    <div class="navBar">
        ...
        <div class="topbar">
            ...
            <div class="search">
                <input type="text" id="search" placeholder="search here" style="border: 1px solid;">
            ...
            <div class="sub-menu-wrap-user" id="subMenu">
                <div class="sub-menu">
                    <div class="user-info">
                        <img src="<?php echo $row['image'] ?>" alt="Profile Photo" srcset="">
                        <div class="user_name">
            ...
            <div class="sub-menu-wrap-development" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
            ...
            <div class="sub-menu-wrap-business" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
            ...
            <div class="sub-menu-wrap-finance" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
            ...
            <div class="sub-menu-wrap-software" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
                    ...
                    for ($i = 0; $i < $countSubCategory3; $i++) {
                        ...
                        $subcategoryName3 = $subcategory3['subcategory_name'];

                    ?>

                        <a href="#" class="sub-menu-link" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                            <p><?php echo $subcategoryName3 ?></p>
                        </a>
            ...
            <div class="sub-menu-wrap-health" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
                    ...
                    ?>
                        ...
                        <a href="#" class="sub-menu-link" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                            <p><?php echo $subcategoryName10 ?></p>
                        </a>
            ...
            <div class="sub-menu-wrap-music" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
                    ...
                    ?>
                        ...
                        <a href="#" class="sub-menu-link" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                            <p><?php echo $subcategoryName11 ?></p>
                        </a>
            ...
            <div class="sub-menu-wrap-teaching" id="subMenu" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                <div class="sub-menu">
                    ...
                    ?>
                        ...
                        <a href="#" class="sub-menu-link" onmouseover="showParentMenu()" onmouseout="hideParentMenu()">
                            <p><?php echo $subcategoryName12 ?></p>
                        </a>
